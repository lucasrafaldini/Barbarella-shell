#!/usr/bin/env bash
# Barbarella — framework de terminal feminino (Bash)
#
# Adicione ao ~/.bashrc:
#   source ~/.barbarella/barbarella.bash

BBL_DIR="${BBL_DIR:-$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)}"
...
# shellcheck source=core/shortcuts.bash
source "${BBL_DIR}/core/shortcuts.bash"
# shellcheck source=core/prompt.bash
source "${BBL_DIR}/core/prompt.bash"
